...
@Component({
  selector: 'app-fieoregistration',
  templateUrl: './fieoregistration.component.html',
  styleUrls: ['./fieoregistration.component.css']
})
export class FieoregistrationComponent implements OnInit {

  title:"Ram";
  posts: any;
  data: any;
  subject1 = "Arrange a call about 'FIEO Registration'";
  message1 = "I am Still confused about 'FIEO Registration', please arrange a call for the same.";
  subject2 = "Still confused about 'FIEO Registration'";
