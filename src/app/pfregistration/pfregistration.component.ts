...
export class PfregistrationComponent implements OnInit {
  ...
  posts: any;
  data: any;
  subject1 = "Arrange a call about 'PF Registration'";
  message1 = "I am Still confused about 'PF Registration', please arrange a call for the same.";
  subject2 = "Still confused about 'PF Registration'";
  message2 = "Still confused about 'PF Registration', please provide Free Advisor Consultation.";
  subject3 = "Complete List of Document required";
  message3 = "Please share the list of required document for the PF Registration.";
  subject4 = "Not Founs Ansrwe our Question";
  message4 = "Not Founs Ansrwe our Question. Please arrange a call for the PF Registration.";
