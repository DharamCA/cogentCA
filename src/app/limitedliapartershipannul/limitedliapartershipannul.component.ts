...
@Component({
  selector: 'app-limitedliapartershipannul',
  templateUrl: './limitedliapartershipannul.component.html',
  styleUrls: ['./limitedliapartershipannul.component.css']
})
export class LimitedliapartershipannulComponent implements OnInit {

  title:"Ram";
  posts: any;
  data: any;
  subject1 = "Arrange a call about 'LLP Annual Compliance'";
  message1 = "I am Still confused about 'LLP Annual Compliance', please arrange a call for the same.";
  subject2 = "Still confused about 'LLP Annual Compliance'";
