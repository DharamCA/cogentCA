...
export class GstreturnfillingComponent implements OnInit {
  ...
  posts: any;
  data: any;
  subject1 = "Arrange a call about 'GST Return filing'";
  message1 = "I am Still confused about 'GST Return filing', please arrange a call for the same.";
  subject2 = "Still confused about 'GST Return filing'";
  message2 = "Still confused about 'GST Return filing', please provide Free Advisor Consultation.";
  subject3 = "Complete List of Document required";
  message3 = "Please share the list of required document for the GST Return filing.";
  subject4 = "Not Found Ansrwe our Question";
  message4 = "Not Found Ansrwe our Question. Please arrange a call for the GST Return filing.";
