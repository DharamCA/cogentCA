...
export class OneprsncompanyComponent implements OnInit {
  ...
  posts: any;
  data: any;
  subject1 = "Arrange a call about 'One Person Company'";
  message1 = "I am Still confused about 'One Person Company', please arrange a call for the same.";
  subject2 = "Still confused about 'One Person Company'";
  message2 = "Still confused about 'One Person Company', please provide Free Advisor Consultation.";
  subject3 = "Complete List of Document required";
  message3 = "Please share the list of required document for the One Person Company.";
  subject4 = "Not Founs Ansrwe our Question";
  message4 = "Not Founs Ansrwe our Question. Please arrange a call for the One Person Company.";
