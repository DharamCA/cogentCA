...
export class IsbnComponent implements OnInit {
  ...
  posts: any;
  data: any;
  subject1 = "Arrange a call about 'ISBN Registration'";
  message1 = "I am Still confused about 'ISBN Registration', please arrange a call for the same.";
  subject2 = "Still confused about 'ISBN Registration'";
