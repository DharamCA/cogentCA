...
export class ShopregistrationComponent implements OnInit {
  ...
  posts: any;
  data: any;
  subject1 = "Arrange a call about 'Shop Establishment'";
  message1 = "I am Still confused about 'Shop Establishment', please arrange a call for the same.";
  subject2 = "Still confused about 'Shop Establishment'";
  message2 = "Still confused about 'Shop Establishment', please provide Free Advisor Consultation.";
  subject3 = "Complete List of Document required";
  message3 = "Please share the list of required document for the Shop Establishment.";
  subject4 = "Not Found Ansrwe our Question";
  message4 = "Not Found Ansrwe our Question. Please arrange a call for the Shop Establishment.";
