...
export class LogodesignComponent implements OnInit {
  ...
  posts: any;
  data: any;
  subject1 = "Arrange a call about 'Logo Designing'";
  message1 = "I am Still confused about 'Logo Designing', please arrange a call for the same.";
  subject2 = "Still confused about 'Logo Designing'";
  message2 = "Still confused about 'Logo Designing', please provide Free Advisor Consultation.";
  subject3 = "Complete List of Document required";
  message3 = "Please share the list of required document for the Logo Designing.";
  subject4 = "Not Founs Ansrwe our Question";
  message4 = "Not Founs Ansrwe our Question. Please arrange a call for the Logo Designing.";
