...
export class PatentComponent implements OnInit {
  ...
  posts: any;
  data: any;
  subject1 = "Arrange a call about 'Patent Creation'";
  message1 = "I am Still confused about 'Patent Creation', please arrange a call for the same.";
  subject2 = "Still confused about 'Patent Creation'";
  message2 = "Still confused about 'Patent Creation', please provide Free Advisor Consultation.";
  subject3 = "Complete List of Document required";
  message3 = "Please share the list of required document for the Patent Creation.";
  subject4 = "Not Found Ansrwe our Question";
  message4 = "Not Found Ansrwe our Question. Please arrange a call for the Patent Creation.";
