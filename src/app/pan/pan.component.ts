...
export class PanComponent implements OnInit {
  ...
  posts: any;
  data: any;
  subject1 = "Arrange a call about 'PAN Card Creation'";
  message1 = "I am Still confused about 'PAN Card Creation', please arrange a call for the same.";
  subject2 = "Still confused about 'PAN Card Creation'";
  message2 = "Still confused about 'PAN Card Creation', please provide Free Advisor Consultation.";
  subject3 = "Complete List of Document required";
  message3 = "Please share the list of required document for the PAN Card Creation.";
  subject4 = "Not Founs Ansrwe our Question";
  message4 = "Not Founs Ansrwe our Question. Please arrange a call for the PAN Card Creation.";
