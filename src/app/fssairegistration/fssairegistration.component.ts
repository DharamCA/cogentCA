...
export class FssairegistrationComponent implements OnInit {
  ...
  posts: any;
  data: any;
  subject1 = "Arrange a call about 'FSSAI Registration'";
  message1 = "I am Still confused about 'FSSAI Registration', please arrange a call for the same.";
  subject2 = "Still confused about 'FSSAI Registration'";
  message2 = "Still confused about 'FSSAI Registration', please provide Free Advisor Consultation.";
  subject3 = "Complete List of Document required";
  message3 = "Please share the list of required document for the FSSAI Registration.";
  subject4 = "Not Found Ansrwe our Question";
  message4 = "Not Found Ansrwe our Question. Please arrange a call for the FSSAI Registration.";
